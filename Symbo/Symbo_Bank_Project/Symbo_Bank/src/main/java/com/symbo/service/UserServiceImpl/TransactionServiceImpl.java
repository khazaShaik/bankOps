...
import com.symbo.dao.PrimaryTransactionDao;
import com.symbo.dao.RecipientDao;
import com.symbo.dao.SavingsAccountDao;
import com.symbo.dao.SavingsTransactionDao;
...
public class TransactionServiceImpl implements TransactionService {
	...
	public List<PrimaryTransaction> findPrimaryTransactionList(String username) {
		...
		List<PrimaryTransaction> primaryTransactionList = user.get().getPrimaryAccount().getPrimaryTransactionList();
	...
	public List<SavingsTransaction> findSavingsTransactionList(String username) {
		Optional<User> user = userService.findByUsername(username);
		List<SavingsTransaction> savingsTransactionList = user.get().getSavingsAccount().getSavingsTransactionList();
